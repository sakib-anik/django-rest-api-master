...
def update_order_status(request):
    try:
        ...
        # Get expo_notification_token from user
        ...
        # ✅ Send push notification if token is present
        if token:
            ...
            push_result = {"warning": "No push token found"}

        return JsonResponse({'success': True, 'message': 'Status updated successfully', 'token': token})
